...
#
# However, when we do this, we also import `edgar_analyzer/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'edgar_analyzer_cli = edgar_analyzer.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'edgar_analyzer_gui = edgar_analyzer.gui:entry_point'
        # ]
    }
)
